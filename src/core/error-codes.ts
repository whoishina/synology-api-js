...
export const CODE_SUCCESS = 0 as const;
export const CODE_UNKNOWN = 9999 as const;
...
// exceed).'
export const authErrorCodes: Record<number, string> = {
...
// Page 29
export const downloadStationErrorCodes: Record<number, string> = {
...
export const fileStationErrorCodes: Record<number, string> = {
...
export const virtualizationErrorCodes: Record<number, string> = {
  401: "Bad parameter.",
...
export const calendarErrorCodes: Record<number, string> = {
  400: "Invalid parameter of file operation",
  401: "Unknown error of file operation",
  402: "System is too busy",
...
// /SurveillanceStation/All/enu/Surveillance_Station_Web_API.pdf
...
// Pages: 71, 81, 85, 93, 103, 113, 131, 132, 139, 144, 155, 167, 169, 176, 187, 190, 191, 201, 211, 212, 217, 222,
// 227, 241, 245, 249, 253, 264, 279, 281, 305, 314, 321, 328, 363, 365, 368, 369, 393, 395, 397, 403, 410, 412, 415,
// 419, 430, 451, 473, 539, 556
export const surveillanceStationErrorCodes: Record<number, string> = {
...
// Source: //
export const iscsiLunErrorCodes: Record<number, string> = {
...
export const iscsiTargetErrorCodes: Record<number, string> = {
...
// core_error_codes is error_codes merged with additional DSM core entries
export const coreErrorCodes: Record<number, string> = {
  ...errorCodes,
  ...
  // NOTE: In the Python source, keys 402, 403, 404 appear again here and overwrite the spread values from errorCodes.
  // This replicates the Python behavior where core_error_codes.update({...}) overwrites existing keys.
